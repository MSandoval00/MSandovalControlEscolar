...
namespace DL
{
    ...
    public partial class MSandovalControlEscolarEntities : DbContext
    {
        public MSandovalControlEscolarEntities()
            : base("name=MSandovalControlEscolarEntities")
        {
        }
        ...
        public virtual int AlumnoMateriaDelete(Nullable<int> idMateria)
        {
            var idMateriaParameter = idMateria.HasValue ?
                new ObjectParameter("IdMateria", idMateria) :
                new ObjectParameter("IdMateria", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AlumnoMateriaDelete", idMateriaParameter);
        }
    }
}
